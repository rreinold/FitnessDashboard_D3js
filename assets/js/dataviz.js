    ...
    svg.selectAll(".month")
        .data(function(d) { return d3.time.months(new Date(d, 9, 1), new Date(d + 1, 3, 1)); })
      .enter().append("path")
        .attr("class", "month")
        .attr("d", monthPath);
...
(function repeat() {
        svg_pullUpsMan
          ...
          article_charts = addArticle("",width_charts);
          article_charts.append("h2").append("a").text("Click for Body Composition Over Time").attr("href","./charts.html");
          svg_charts = article_charts.append("svg").attr("width",width_charts)
                .attr("height",defaultSVGHeight).append("g").attr("transform","translate(" + (width_charts * 1 / 3) + "," + defaultSVGVerticalCenter / 2 + ")");

          svg_charts
              .append("path").attr("fill","#3D9970").attr("d","M93,90H9V8c0-1.104-0.896-2-2-2S5,6.896,5,8v84c0,1.104,0.896,2,2,2h86c1.104,0,2-0.896,2-2S94.104,90,93,90  z")
            svg_charts
                    .append("path").attr("fill","#3D9970").attr("d","M91.745,26.448c0-2.699-2.188-4.888-4.888-4.888s-4.888,2.188-4.888,4.888c0,1.306,0.52,2.486,1.354,3.363  l-9.419,17.442c-0.009,0-0.018-0.003-0.027-0.003c-0.831,0-1.601,0.227-2.286,0.592l-6.762-5.778  c0.055-0.294,0.091-0.595,0.091-0.906c0-2.699-2.188-4.888-4.888-4.888s-4.888,2.188-4.888,4.888c0,0.731,0.171,1.417,0.459,2.04  L46.395,60.25c-0.07-0.003-0.136-0.021-0.207-0.021c-1.201,0-2.286,0.45-3.136,1.168l-6.902-5.898  c0.127-0.435,0.216-0.886,0.216-1.362c0-2.699-2.188-4.888-4.888-4.888s-4.888,2.188-4.888,4.888c0,1.194,0.445,2.273,1.155,3.121  l-8.589,17.747c-0.217-0.03-0.433-0.066-0.658-0.066c-2.7,0-4.888,2.188-4.888,4.888s2.188,4.888,4.888,4.888  c2.699,0,4.888-2.188,4.888-4.888c0-0.997-0.302-1.923-0.815-2.696l8.769-18.119c0.047,0.001,0.09,0.014,0.137,0.014  c0.747,0,1.446-0.181,2.079-0.48l7.748,6.621c0.027,2.676,2.2,4.839,4.883,4.839c2.699,0,4.888-2.188,4.888-4.888  c0-1.167-0.426-2.224-1.109-3.065l8.752-16.208c0.42,0.118,0.855,0.201,1.313,0.201c0.91,0,1.752-0.265,2.482-0.698l6.62,5.657  c-0.087,0.365-0.145,0.741-0.145,1.133c0,2.699,2.188,4.888,4.888,4.888s4.888-2.188,4.888-4.888c0-1.232-0.471-2.344-1.223-3.203  l9.514-17.618C89.661,31.208,91.745,29.079,91.745,26.448z");

          width_fusion = 300;
          article_fusion = addArticle("",width_fusion);
          article_fusion.append("h2").append("a").text("Click for Data Fusion!").attr("href","./fusion.html");

          svg_fusion = article_fusion.append("svg").attr("width",width_fusion)
                .attr("height",defaultSVGHeight).append("g").attr("transform","translate(" + (width_fusion * 1 / 3) + "," + defaultSVGVerticalCenter / 2 + ")");

          svg_fusion
              .append("path").attr("fill","#0074D9").attr("d","M93,90H9V8c0-1.104-0.896-2-2-2S5,6.896,5,8v84c0,1.104,0.896,2,2,2h86c1.104,0,2-0.896,2-2S94.104,90,93,90  z")
            svg_fusion
                    .append("path").attr("fill","#0074D9").attr("d","M91.745,26.448c0-2.699-2.188-4.888-4.888-4.888s-4.888,2.188-4.888,4.888c0,1.306,0.52,2.486,1.354,3.363  l-9.419,17.442c-0.009,0-0.018-0.003-0.027-0.003c-0.831,0-1.601,0.227-2.286,0.592l-6.762-5.778  c0.055-0.294,0.091-0.595,0.091-0.906c0-2.699-2.188-4.888-4.888-4.888s-4.888,2.188-4.888,4.888c0,0.731,0.171,1.417,0.459,2.04  L46.395,60.25c-0.07-0.003-0.136-0.021-0.207-0.021c-1.201,0-2.286,0.45-3.136,1.168l-6.902-5.898  c0.127-0.435,0.216-0.886,0.216-1.362c0-2.699-2.188-4.888-4.888-4.888s-4.888,2.188-4.888,4.888c0,1.194,0.445,2.273,1.155,3.121  l-8.589,17.747c-0.217-0.03-0.433-0.066-0.658-0.066c-2.7,0-4.888,2.188-4.888,4.888s2.188,4.888,4.888,4.888  c2.699,0,4.888-2.188,4.888-4.888c0-0.997-0.302-1.923-0.815-2.696l8.769-18.119c0.047,0.001,0.09,0.014,0.137,0.014  c0.747,0,1.446-0.181,2.079-0.48l7.748,6.621c0.027,2.676,2.2,4.839,4.883,4.839c2.699,0,4.888-2.188,4.888-4.888  c0-1.167-0.426-2.224-1.109-3.065l8.752-16.208c0.42,0.118,0.855,0.201,1.313,0.201c0.91,0,1.752-0.265,2.482-0.698l6.62,5.657  c-0.087,0.365-0.145,0.741-0.145,1.133c0,2.699,2.188,4.888,4.888,4.888s4.888-2.188,4.888-4.888c0-1.232-0.471-2.344-1.223-3.203  l9.514-17.618C89.661,31.208,91.745,29.079,91.745,26.448z");
